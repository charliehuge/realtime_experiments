...
BENCHMARK(ThingWithCb_SetUnset<ThingWithCbAndTrap<CbData>>);
...
BENCHMARK(ThingWithCb_Process<ThingWithCbAndTrap<CbData>>);
...
BENCHMARK(ThingWithCb_ProcessNoContention<ThingWithCbAndTrap<CbData>>);
